...
NewGuiPart109.Text = "Arch Linux  , Script Made By Advancedev, Uploaded By DemonHunter"
...
NewGuiPart142.Text = "After the map saves, open a new place on studio, then right click Lighting and \"Insert from file...\", then select your file and run the unpacker script inside the folder. (idk think so this supports mobile)"
